function [thick,thin,all] = track_anvil_area(k,GEOIRFILE,GEOIRPATH,simnameshort)
   ...
   % BW2 = bwperim(BW,8);
    ...
    G = bwdist(BW_thin);
    BW_thin_buffer = (G >= 5);
    BW_thin_buffer = imcomplement(BW_thin_buffer);
    %BW_filled = imfill(BW,"holes");
    BW_filled = BW_thin_buffer;
    perim_thin= bwperim(BW_filled,8);
    %TB_thin=Tb_11;
    %TB_thin(BW_filled==0)=NaN;

    BW_inter = BW_thin_buffer;
    BW_inter(BW_thick_buffer==1)=0;
    thin = BW_inter;
    all  = BW_filled;
